  ...
  <div id="home-page">
    ...
    <main>
      ...
      <section id="trust" class="trust-section">
        <div class="container">
          <div class="section-header">
            ...
            <p>
              Nyota Cash is more than just loans. We're a licensed, regulated financial services
      ...
      <section id="features" class="features-section">
        <div class="container">
          <div class="section-header">
            <h2>Why Kenyan Youth Choose Nyota Cash</h2>
            <p>
      ...
      <section id="apply" class="cta-section">
        <div class="container cta-inner">
          ...
          <p>
            Join the youth movement with Nyota Cash. Apply now and get funds in
